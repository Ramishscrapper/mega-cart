    ...
    return (
        <>
            <div className={`minicart-wrapper ${isActive ? "active" : ""}`}>
                <div className="close-minicart" onClick={() => setActive(false)}>&#10060;</div>
                {(cartItems.length > 0) ? (
                    <>
                        ...
                        <div className="total">
                            <div className="text"><span>Total Amount: </span></div>
                            <div className="price"><strong>${minicartTotal}</strong></div>
                        </div>
                        <div className="cart-action">
                            <Link to="/cart" onClick={cartAction}>View in cart</Link>
                        </div>
                    </>
                ) : (
                    <>
